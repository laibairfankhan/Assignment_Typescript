...
//Test 1 equality  with string: 
console.log(`Equality test with string:`, "Apple" == "Banana");
//Test 1 result is false:
//Test 2 Inequality with string:
console.log(`Inequality test with string:`, "Apple" != "Banana");
//Test 2 reult true:
...
//Test 4 result True:
console.log(`Equality test with number:`, 87 == 78);
//Test 4 result False:
//Test 5 Inequality with number:
console.log(`Inequality test with number:`, 87 != 78);
//Test 5 reult True:
...
//Test 11 OR Operator:
console.log(`OR Operator test with number:`, 87 != 78 || 87 < 9);
//Test 11 result True:
console.log(`OR Operator test with number:`, 8 == 7 || 8 > 89);
